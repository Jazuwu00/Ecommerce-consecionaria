...
/*
Accesorio=ABM
AutoDisponible0KM=ABM
AutoUsado=BM
Cliente=BM
Color=ABM
FormaPago=ABM --En teoría esta tabla al modificarse se cambiaría todo el funcionamiento del sistema (Circuito 1)
Moroso=BM
Persona=BM
Propietario=B
Condicion=ABM
CondicionTipoSeguro=ABM
TipoSeguro=ABM
ReparaciónDisponible=ABM
Seguro0KM=M --Debe poderse borrar la vigencia del seguro del automóvil (la única forma de hacer esto a través de proceso es en el circuito 2 cuando no cumple con los accesorios, es decir que agregó accesorios en otro lugar que no sea la concesionaria).
*/
